...
#|\\ warning: false 
  ...
  #|\\ message: false
  #|\\ warning: false 
  labs(title = "Jalen Hurts QBR Over the Season so far",
       y = "QBR", 
       x = "Game Week",
caption = "Source: Sports Reference | By: Kaitlyn Schmeling",
    subtitle = "Looking at his improvement over the 10 week game scheldue.")
  #|\\ message: false
  #|\\ warning: false 
   theme_set(theme_gray())
#|\\ message: false
#|\\ warning: false 
```
This graph shows how Hurts' QBR for himself showing the improvement he has had per game week. This overall shows that Jalen Hurts could be one of the contenders in the Super Bowl if he continues to improve each game.